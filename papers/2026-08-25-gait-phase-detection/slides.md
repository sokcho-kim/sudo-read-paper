...
+ 1·2번 실험은 6명짜리 Zafar 대신 **Camargo 2021 (Georgia Tech, 22명)** 데이터셋이 적합
  — 스터디 목록의 실습 질문(subject-wise vs window-wise split 비교)과 동일한 문제의식

---

# 7.3 스터디 로드맵에서 오늘 발표의 위치

랩 추천 논문 목록(5주 커리큘럼) 기준:

| 주차 | 내용 | 오늘과의 관계 |
|------|------|---------------|
| 1주차 | Kong & Tomizuka HMM (2009/2011) — 고전 | 순차 모델 관점의 대조군 |
| **2주차** | **Fiaz et al. 비판적 리뷰 ← 오늘** | 검증 파트가 추가 기여 |
| 3주차 | Young & Hargrove 2016 + Sensors 2024 | subject-independent 설계 학습 |
| 4주차 | Zhang 2021 · Shin/Ko/Kong 2026 | 재활 로봇·임상 확장 |
| 5주차 | **Camargo 2021 데이터셋 자체 실험** | 오늘 제안한 실험들의 실행처 |

- 오늘 찾은 **윈도우 수 모순·라벨 기존재** 이슈는 목록에 없던 신규 발견
  → 5주차 실습 설계 시 "논문 수치 검산" 단계를 넣자는 제안으로 연결
