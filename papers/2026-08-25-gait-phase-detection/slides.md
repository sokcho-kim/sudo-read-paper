...
우리가 배운 Rancho 분류는 8개 이벤트, 7개 구간.
하지만 **센서가 확실히 아는 경계는 HS와 TO 둘뿐**입니다 — 발바닥 스위치가
눌리고 떨어지는 순간. 나머지 경계는 신호에 표식이 없어 정답을 못 만듭니다.

그래서 이 논문은 문제를 3지선다로 줄입니다:

| 우리가 배운 7~8단계 | 이 논문 |
|---|---|
| 입각기 5단계 전부 | **stance** |
| 유각기 (초기·말기 유각) | **swing** |
| 유각기 중 중간 유각 | **mid-swing** |

mid-swing은 동작 기준이 아니라 **시간으로 자른 정의**(swing 가운데 20~25%)
— 기억해두십시오.
